...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  before_action :check_administrator_role, only: [:new, :create]
  ...
  def after_sign_up_path_for(resource)
    # Customize the redirect path after a successful sign-up
    # For example, redirect to the administrator dashboard
  end
  ...
  def check_administrator_role
    redirect_to root_path unless current_user&.role == 'administrator'
  end
